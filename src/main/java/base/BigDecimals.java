...
public class BigDecimals {
    ...
    public static BigDecimal safeDivide(BigDecimal b1, BigDecimal b2, int scale) {
        return safeDivide(b1, b2, scale, RoundingMode.HALF_UP);
    }
    ...
    public static String toAmount(Float val) {
        return of(val).setScale(2, RoundingMode.HALF_UP).toString();
    }
    ...
    public static BigDecimal of(String val) {
        return StringUtils.isBlank(val) ? BigDecimal.ZERO : new BigDecimal(val);
    }
