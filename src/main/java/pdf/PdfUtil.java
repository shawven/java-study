...
public class PdfUtil {
    ...
    public static void main(String[] args) throws IOException {
        ...
        String template =  table.getNumberOfRows() > 4 ? "F:/defaultServiceContract2.pdf" : "F:/defaultServiceContract1.pdf";
        PdfUtil pdfUtil = new PdfUtil(template, "f:/newDefaultServiceContract.pdf");
