...
/**
 * 自定义响应结构工具类, 适应 RESTFull 风格
 * @author FS
 * @date 2018-10-08 11:17
 */
public class ResponseUtils {
    ...
    public static ResponseEntity<Response> build(boolean bool, HttpStatus status, String msg) {
        Response objectResponse = new Response<Object>(bool, status.value(), msg, null);
        return new ResponseEntity<>(objectResponse, status);
    }
    ...
    public static <T> ResponseEntity<Response<T>> build(boolean bool, HttpStatus status, String msg, T data) {
        Response<T> Response = new Response<>(bool, status.value(), msg, data);
